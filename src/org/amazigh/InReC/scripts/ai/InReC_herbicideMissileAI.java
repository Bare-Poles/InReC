...
public class InReC_herbicideMissileAI implements MissileAIPlugin, GuidedMissileAI {
    ...
    //Max angle of the waving in degree (0.5 strength with ECCM). Set to a negative value to avoid all waving.
    ...
    private final float DECAY_MIN=0.5f;
    ...
    */
    ...
    public InReC_herbicideMissileAI(MissileAPI missile, ShipAPI launchingShip) {
	...
	private void applySwarmOffset() {
		int i = 15; //We don't want to take too much time, even if we get unlucky: only try 15 times
