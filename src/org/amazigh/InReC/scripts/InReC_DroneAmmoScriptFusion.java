...
public class InReC_DroneAmmoScriptFusion implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin {
    		...
    		if (weapon.getAmmo() <= 15) {
    	        ...
    	        for (int i = 0; i < 2; i++) {
        			...
        			engine.addSmoothParticle(MathUtils.getPointOnCircumference(ship.getLocation(), 4f, angle),
                			...
                			1f,
                			MathUtils.getRandomNumberInRange(0.25f, 0.5f),
                			new Color(183,45,30,sparkAlpha));
    	        }
    		}
